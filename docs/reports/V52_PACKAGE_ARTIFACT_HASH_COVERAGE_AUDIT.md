...
The handoff bundle lists 31 unique artifacts. The current hash snapshot lists
32 artifacts. Twenty-five handoff artifacts are hash-covered by the snapshot. Six
