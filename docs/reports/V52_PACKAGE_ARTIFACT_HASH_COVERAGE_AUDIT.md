...
The handoff bundle lists 27 unique artifacts. The current hash snapshot lists
28 artifacts. Twenty-one handoff artifacts are hash-covered by the snapshot. Six
