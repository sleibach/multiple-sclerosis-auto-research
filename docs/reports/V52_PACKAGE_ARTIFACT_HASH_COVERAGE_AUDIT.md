...
The handoff bundle lists 30 unique artifacts. The current hash snapshot lists
31 artifacts. Twenty-four handoff artifacts are hash-covered by the snapshot. Six
