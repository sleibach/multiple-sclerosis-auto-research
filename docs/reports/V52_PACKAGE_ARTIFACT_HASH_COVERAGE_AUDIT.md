...
The handoff bundle lists 28 unique artifacts. The current hash snapshot lists
29 artifacts. Twenty-two handoff artifacts are hash-covered by the snapshot. Six
