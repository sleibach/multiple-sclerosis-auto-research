...
The handoff bundle lists 29 unique artifacts. The current hash snapshot lists
30 artifacts. Twenty-three handoff artifacts are hash-covered by the snapshot. Six
