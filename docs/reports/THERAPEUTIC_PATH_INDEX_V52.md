...
| `docs/reports/THERAPEUTIC_NO_TARGET_PUBLIC_ABSTRACT_V52.md` | public reader / external reviewer | concise public abstract: monitoring-ready, no current target |
...
| `docs/validation/VALIDATION_PACKAGE_ROUTE_CLASSIFIER_V52.json` | validation operator / tooling | generated JSON mirror of the route classifier TSV |
...
| `docs/validation/MONITORING_RESULT_CLASS_EXAMPLES_V52.md` | validation operator | concrete scenario-to-class examples for future monitoring outcomes |
...
| `docs/workups/genetics/CHR1_TARGET_RESOLUTION_DECISION_COMPACT_V52.tsv` | chr1 KIF21B/GPR25 | compact decision states for genotype-linked and perturbation packages |
