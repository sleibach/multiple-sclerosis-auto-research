...
| measure | result |
|---|---:|
| Public Markdown documents in the route graph | 70 |
...
| Documents reachable from root | 70/70 |
| Non-root documents with an inbound link | 66/66 |
| Documents with an outbound next step | 70/70 |
| Documents able to return to the onboarding landing page | 70/70 |
