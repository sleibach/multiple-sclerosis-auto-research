...
The eight V55 diagrams are dense overview maps. Shrinking a diagram until it fits
...
| Mobile | 2.87-3.28 px |
| Tablet | 6.16-7.04 px |
| Portrait-print model | 5.88-6.72 px |
