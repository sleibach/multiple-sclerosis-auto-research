...
The committed audit covers forty-three reader-facing pages:
...
- the progression snapshot-versus-movie case study;
- the confound-check quick reference;
- the four-case learning path;
- the collaborator workshop guide;
- the outside-context-to-test case study;
...
- the data-source contribution on-ramp;
- the method contribution on-ramp;
- the documentation and visual contribution on-ramp;
- the patient and public safety boundary;
- the find-by-term and misconception index;
- the V55 public release notes;
- the public collaborator invitation;
- the starter contribution board;
- the contribution examples by type;
...
| measure | result |
|---|---:|
| Reader-facing documents | 43 |
| Prose words measured | 44,556 |
| Sentences measured | 4,724 |
...
Sixteen sentences remain over 30 words. Most enumerate required data fields,
