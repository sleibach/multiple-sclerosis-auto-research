...
- `144` V43-V47 analysis directories;
- `101` directories with synthetic path/content markers;
- approximately `286 MiB` total across `analysis/v43_*`, `analysis/v44_*`,
...
Current footprint is small enough (`~286 MiB`) to keep all V43-V47 synthetic and
