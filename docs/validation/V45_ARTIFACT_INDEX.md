...
The current run indexes `2731` paths across `8` fronts and `9` evidence classes.
...
|---|---:|---|
| synthetic method behavior | 1275 | method behavior/planning only; never biological evidence |
...
| software | 107 | executable infrastructure; no biological claim by itself |
