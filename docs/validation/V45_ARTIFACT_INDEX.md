...
The current run indexes `2411` paths across `8` fronts and `9` evidence classes.
...
|---|---:|---|
| synthetic method behavior | 1155 | method behavior/planning only; never biological evidence |
| documentation/governance | 737 | governance/readiness documentation |
| validation infrastructure | 252 | mechanical guardrail/readiness; no biological claim |
| software | 103 | executable infrastructure; no biological claim by itself |
...
| resume state | 2 | resume state and running backlog |

## Drift Since Earlier Snapshot

The path count increased by about `2072-2073` paths because V45 continued after
