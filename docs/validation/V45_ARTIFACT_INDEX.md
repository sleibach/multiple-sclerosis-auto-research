...
The current run indexes `2748` paths across `8` fronts and `9` evidence classes.
...
|---|---:|---|
| synthetic method behavior | 1282 | method behavior/planning only; never biological evidence |
| documentation/governance | 836 | governance/readiness documentation |
| validation infrastructure | 358 | mechanical guardrail/readiness; no biological claim |
| software | 108 | executable infrastructure; no biological claim by itself |
