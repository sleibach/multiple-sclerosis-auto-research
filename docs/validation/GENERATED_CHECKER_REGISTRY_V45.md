...
Purpose: map V45/V46/V47 scripts to documentation references, likely analysis output
...
exceptions, so all currently indexed V45/V46/V47 scripts have detected output
directories.
