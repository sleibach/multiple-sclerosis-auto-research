...
If available, fill this section from
`analysis/validation_command_runs/metadata_missingness/<cohort>/metadata_missingness_scores.tsv`
generated by `scripts/v45_metadata_missingness_scorer.py`.
