...
|---|---|---:|
| no raw git scanner | `PASS` | `0.503` |
| locked artifact hash audit | `PASS` | `0.068` |
| regression aggregator | `PASS` | `68.630` |
| command-plan consistency | `PASS` | `0.305` |
| governance refresh | `PASS` | `15.114` |
| total | `PASS` | `84.620` |
