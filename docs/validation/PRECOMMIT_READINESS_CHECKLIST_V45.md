...
|---|---|---:|
| no raw git scanner | `PASS` | `0.571` |
| locked artifact hash audit | `PASS` | `0.055` |
| regression aggregator | `PASS` | `73.565` |
| command-plan consistency | `PASS` | `0.350` |
| governance refresh | `PASS` | `26.798` |
| total | `PASS` | `101.339` |
