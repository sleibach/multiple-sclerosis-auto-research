...
| precommit_readiness | `PASS` | 5/5 checks pass; 101.339 seconds | repository/readiness guard status only |
| collaborator_path_resolution | `PASS` | 171 resolved; 0 missing | handoff links resolve; no validation claim |
