...
- Eligible site-state pairs: `43`.
- Patient-state-module rows: `185`.
- Primary family size: `10`.
- Best raw centered-transport feature: `Mono_macro__inflammatory_nfkb` (max-T p=`0.682633`).
- Frozen verdict: **NO_RESPONSE_SPECIFIC_DISTRIBUTIONAL_FEATURE**.
