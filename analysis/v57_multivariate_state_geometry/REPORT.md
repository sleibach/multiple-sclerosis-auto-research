# V57 Multivariate Cell-State Geometry Probe
...
- Eligible pair-compartment rows: 43
- Unique patients: 22
- Patient-label permutations: 200,000
- Top raw compartment: `Mono_macro` (effect
  1.171, max-T p=0.4091)
- Top residualized compartment: `Mono_macro` (effect
  1.637, max-T p=0.1770)
- Passing compartments: none

Verdict: **NO_RESPONSE_SPECIFIC_JOINT_GEOMETRY**.
