...
|---:|---|---|---|
| 1 | `current_action_card` | `.venv/bin/python scripts/v45_current_action_card.py --outdir analysis/v45_current_action_card` | `analysis/v45_current_action_card/current_action_card_summary.json` |
