...
| ToleDYNAMIC design-branch lock | done | Preserves original module-family hash `6c34...77d` while binding its randomized contrast to the documented both-arm exception; active-only paired change is the machine-enforced public-design default under design hash `1d7734...45c9`. |
