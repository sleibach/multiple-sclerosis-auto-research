...
| 55 | Infrastructure | Refresh the V45 artifact index after the later V45 checkpoints and document drift from the earlier index | in-progress | Generated by continued V45 outputs after item 38; keeps governance current. |
| 56 | Validation readiness | Add a Gafson-arrival runbook that maps the command-runner plan to the exact V42 preregistration gates | todo | Generated by command-runner work; prepares for data arrival without improvisation. |
| 57 | Integrity | Add a locked-rule hash audit script for `LOCKED_RULE_V22.md` and frozen preregistration files | todo | Generated by long-block maintenance; verifies readiness work did not edit locked artifacts. |
| 58 | Infrastructure | Add synthetic-output retention and storage policy for V45 regression/simulation directories | todo | Generated by expanding synthetic outputs; clarifies what can be pruned or archived later. |
| 59 | Operations | Add an OpenGWAS JWT renewal/runbook note for the 2026-06-19 expiry even though V45 is mostly OpenGWAS-independent | todo | Generated by recurring expiry flag; prevents silent auth false nulls in later genetics tasks. |
| 60 | Validation readiness | Add a single-page first-24-hours operator checklist for received validation data | todo | Generated by command-runner, triage-board, and collaborator-package work; reduces improvisation when data arrives. |
| 61 | Validation readiness | Add a preflight failure taxonomy mapping common guard failures to allowed repair actions | todo | Generated by the growing preflight/checksum/subject-map/coverage guard suite. |
| 62 | Infrastructure | Wire module-coverage precheck into the validation command-runner plan as an explicit pre-harness step | todo | Generated by item 54; keeps operator plans synchronized with the new guard. |
| 63 | Cohort dependence | Add a Gafson/Karolinska/GSE228330 follow-up calendar template with evidence gates and no-data-deadline actions | todo | Generated by live acquisition tracker and delayed-data risk. |
| 64 | Infrastructure | Add a combined refresh helper for the artifact index and compute/storage summary | todo | Generated because item 55 and item 53 drift as new V45 artifacts are added. |
| 65 | Integrity | Add a pre-commit readiness checklist tying no-raw scanner, locked-hash audit, regression aggregator, and artifact refresh | todo | Generated by expanding integrity guardrails across V45. |
