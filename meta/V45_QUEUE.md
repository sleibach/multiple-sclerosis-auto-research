...
| 58 | Infrastructure | Add synthetic-output retention and storage policy for V45 regression/simulation directories | in-progress | Generated by expanding synthetic outputs; clarifies what can be pruned or archived later. |
