...
| 66 | Validation readiness | Add a machine-readable first-24h checklist TSV for operator status capture | in-progress | Generated by item 60; enables receipt-stage status capture without editing prose. |
