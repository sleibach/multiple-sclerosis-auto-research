...
| 52 | Validation readiness | Add a GSE228330 outcome-label addendum template for the case where authors provide response labels | in-progress | Generated by optional GSE228330 label request; keeps future upgrade from context-only blinded and mechanical. |
