...
| 22 | Cohort dependence | Write Karolinska-specific preregistration addendum template, to be finalized only if labels arrive | in-progress | Generated by V45 item 17; prevents platform/timepoint decisions after seeing labels. |
