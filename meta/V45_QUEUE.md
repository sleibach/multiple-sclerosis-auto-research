...
| 47 | Robustness | Add explicit missing-baseline and missing-follow-up fixtures to the subject-map sanity checker regression outputs | in-progress | Generated by V45 subject-map guard; improves coverage beyond unverified-map failure. |
