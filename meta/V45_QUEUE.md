...
| 62 | Infrastructure | Wire module-coverage precheck into the validation command-runner plan as an explicit pre-harness step | in-progress | Generated by item 54; keeps operator plans synchronized with the new guard. |
