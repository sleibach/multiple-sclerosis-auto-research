...
| 35 | Cohort dependence | Build a live-cohort acquisition packet index covering exact paths, blockers, and ready-to-run commands | in-progress | Generated by V45 items 17/23/24; reduces handoff friction across Gafson, Karolinska, and GSE228330. |
| 36 | Power/design | Add dropout and missing-timepoint sensitivity table to the stakeholder cohort-size guidance | todo | Generated by V45 item 6 and GSE228330 missing-timepoint structure. |
| 37 | Robustness | Add regression test wrapper for the primary V42 Gafson synthetic harness | todo | Generated by V45 regression work; keeps primary harness guardrails aligned with secondary/context tests. |
| 38 | Infrastructure | Build a V45 artifact index mapping each committed output to front, status, and synthetic/real-data classification | todo | Generated by V45 portfolio growth; supports resume and external review. |
| 39 | Validation readiness | Add a response-column audit utility for pharmacodynamic-only metadata outside the full preflight path | todo | Generated by V45 item 23/24; lightweight guard for collaborators sending metadata drafts. |
| 40 | Cohort dependence | Add a data-use and terms-capture template for received cohort packages before harness execution | todo | Generated by V45 acquisition hardening; ensures low-barrier received data are tracked without committing restricted terms or credentials. |
