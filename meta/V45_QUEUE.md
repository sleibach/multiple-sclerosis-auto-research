...
| 46 | Validation readiness | Add an author-provided outcome-label dictionary template for received labels before preregistration addenda | in-progress | Generated by Gafson/Karolinska/GSE228330 request paths; prevents ambiguous response definitions from entering validation. |
...
| 50 | Infrastructure | Add a CI-style V45 regression aggregator that runs primary, secondary, preflight, checksum, response-column, and subject-map synthetic checks | todo | Generated by V45 guardrail growth; provides one command for future smoke/regression verification. |
| 51 | Validation readiness | Add a no-raw-data-in-git scanner for quarantine/raw paths and restricted terms before commits | todo | Generated by data-use governance; prevents accidental commit of received individual-level data or restricted agreements. |
| 52 | Validation readiness | Add a GSE228330 outcome-label addendum template for the case where authors provide response labels | todo | Generated by optional GSE228330 label request; keeps future upgrade from context-only blinded and mechanical. |
| 53 | Infrastructure | Add a V45 synthetic compute/storage budget summary so method-characterization outputs are transparent to reviewers | todo | Generated by large synthetic-output growth; records file counts, sizes, and method-only classification. |
| 54 | Validation readiness | Add a module-coverage precheck utility for expression matrices before full harness execution | todo | Generated by array-processing and intake work; catches missing V22/confounder genes early without scoring outcomes. |
