...
| 61 | Validation readiness | Add a preflight failure taxonomy mapping common guard failures to allowed repair actions | in-progress | Generated by the growing preflight/checksum/subject-map/coverage guard suite. |
...
| 66 | Validation readiness | Add a machine-readable first-24h checklist TSV for operator status capture | todo | Generated by item 60; enables receipt-stage status capture without editing prose. |
| 67 | Validation reporting | Add a pre-registered validation-result report template keyed to the V42 outcome grid | todo | Generated by Gafson runbook and first-24h checklist; prevents post-hoc report framing. |
| 68 | Infrastructure | Add a package receipt manifest template for non-sensitive file inventory and terms status | todo | Generated by first-30-minute receipt checklist. |
| 69 | Infrastructure | Add a gate-output bundler manifest so preflight/checksum/coverage/subject-map outputs can be handed off together | todo | Generated by first-24h operator workflow. |
| 70 | Cohort dependence | Add a follow-up escalation matrix for delayed author labels after request packets are sent | todo | Generated by Gafson/Karolinska/GSE228330 single-cohort-dependence risk. |
