...
| 53 | Infrastructure | Add a V45 synthetic compute/storage budget summary so method-characterization outputs are transparent to reviewers | in-progress | Generated by large synthetic-output growth; records file counts, sizes, and method-only classification. |
