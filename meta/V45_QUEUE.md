...
| 16 | Infrastructure | Implement pharmacodynamic-only module trajectory harness for GSE228330-like open cohorts | in-progress | Generated by V45 item 12; context-only outputs, no response metrics. |
