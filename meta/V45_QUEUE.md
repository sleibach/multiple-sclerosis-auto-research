...
| 83 | Infrastructure | Add latest governance refresh and precommit run after new templates are committed | in-progress | Generated by continuing V45 drift; keeps indexes current. |
