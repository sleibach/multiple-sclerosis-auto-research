...
| 65 | Integrity | Add a pre-commit readiness checklist tying no-raw scanner, locked-hash audit, regression aggregator, and artifact refresh | in-progress | Generated by expanding integrity guardrails across V45. |
