...
| 21 | Robustness | Optimize and scale batch-guard calibration to the full V45 multi-confounder grid | in-progress | Generated by V45 item 13; pilot is promising but not enough to change the harness. |
| 22 | Cohort dependence | Write Karolinska-specific preregistration addendum template, to be finalized only if labels arrive | todo | Generated by V45 item 17; prevents platform/timepoint decisions after seeing labels. |
| 23 | Infrastructure | Build validation intake preflight script for quarantine checksums, schema checks, and no-response-label guardrails | todo | Generated by V45 item 17; durable guard before any incoming cohort is opened. |
| 24 | Pharmacodynamic context | Prepare GSE228330 pharmacodynamic-only acquisition/runbook for the context harness | todo | Generated by V45 item 16/17; open cohort can exercise context harness without response claims. |
| 25 | Data-free validation | Re-run APC convergence excluding all validation/readiness artifacts generated after V42 | todo | Generated by V45 item 7/8; guards against readiness-document circularity. |
| 26 | External account | Update skeptical external checklist with V45 secondary harness and request-tracker readiness claims | todo | Generated by V45 items 15-17; keeps the external account current. |
