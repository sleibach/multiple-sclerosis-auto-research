...
| 77 | Integrity | Add command-plan consistency check into the pre-commit readiness wrapper | in-progress | Generated by item 73; makes command-plan drift part of the standard guard sequence. |
