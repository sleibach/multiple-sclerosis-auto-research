...
| 69 | Infrastructure | Add a gate-output bundler manifest so preflight/checksum/coverage/subject-map outputs can be handed off together | in-progress | Generated by first-24h operator workflow. |
