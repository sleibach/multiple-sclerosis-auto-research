...
| 40 | Cohort dependence | Add a data-use and terms-capture template for received cohort packages before harness execution | in-progress | Generated by V45 acquisition hardening; ensures low-barrier received data are tracked without committing restricted terms or credentials. |
| 41 | Infrastructure | Build a checksum-manifest validator for outbound/acquisition packages outside the full intake path | todo | Generated by V45 package handoff work; catches drift in request packets and received-file manifests. |
| 42 | Robustness | Add missing-timepoint/dropout synthetic stress checks for the secondary postpartum and T/B harnesses | todo | Generated by V45 secondary harness hardening; complements primary stakeholder power sensitivity. |
| 43 | Infrastructure | Build a collaborator package README bundling CRF checklist, request packets, and intake commands | todo | Generated by V45 external handoff work; reduces single-person operational dependence. |
| 44 | Validation readiness | Add a local array-processing readiness checklist for Clariom/CEL cohorts such as GSE228330 and Karolinska | todo | Generated by V45 GSE228330/Karolinska scouts; separates expression reprocessing prerequisites from response-label blockers. |
| 45 | Infrastructure | Build a validation command-runner checklist that sequences response audit, intake preflight, subject-map sanity, and frozen harness handoff | todo | Generated by V45 guardrail proliferation; reduces operator error when a cohort package arrives. |
| 46 | Validation readiness | Add an author-provided outcome-label dictionary template for received labels before preregistration addenda | todo | Generated by Gafson/Karolinska/GSE228330 request paths; prevents ambiguous response definitions from entering validation. |
| 47 | Robustness | Add explicit missing-baseline and missing-follow-up fixtures to the subject-map sanity checker regression outputs | todo | Generated by V45 subject-map guard; improves coverage beyond unverified-map failure. |
| 48 | External account | Add a V45 readiness appendix to the skeptical external account with artifact index and command handoff links | todo | Generated by artifact-governance work; makes V45 outputs reviewable by a skeptical external reader. |
| 49 | Cohort dependence | Add a received-data triage status board separating sent, received, quarantined, preflighted, preregistered, and harness-ready states | todo | Generated by acquisition operations; avoids treating "data received" as "ready to analyze." |
