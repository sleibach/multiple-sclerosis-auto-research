...
| 19 | Data-free validation | Re-run convergence sensitivity excluding all corpus-synthesis/report-derived rows | in-progress | Further guards against report-corpus circularity. |
