...
| 27 | Robustness | Add regression tests for context-only and secondary-real-ingest harness synthetic checks | in-progress | Generated by V45 items 15-16; infrastructure should fail fast if future edits break guardrails. |
