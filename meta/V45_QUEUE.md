...
| 39 | Validation readiness | Add a response-column audit utility for pharmacodynamic-only metadata outside the full preflight path | in-progress | Generated by V45 item 23/24; lightweight guard for collaborators sending metadata drafts. |
