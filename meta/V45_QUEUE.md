...
| 51 | Validation readiness | Add a no-raw-data-in-git scanner for quarantine/raw paths and restricted terms before commits | in-progress | Generated by data-use governance; prevents accidental commit of received individual-level data or restricted agreements. |
...
| 55 | Infrastructure | Refresh the V45 artifact index after the later V45 checkpoints and document drift from the earlier index | todo | Generated by continued V45 outputs after item 38; keeps governance current. |
