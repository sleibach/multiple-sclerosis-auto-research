...
| 79 | Validation reporting | Add minimum non-sensitive author-run output specification for external harness runs | in-progress | Generated by author-run option and validation report template. |
