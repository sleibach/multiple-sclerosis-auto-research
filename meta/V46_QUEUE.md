...
| 25 | Returned-package handling | Add repair-request template generator for unscoreable returned packages with missing metrics, missing labels, terms ambiguity, or schema mismatch | todo | Self-generated after item 23; converts blocked safe classes into concrete author-facing repair asks without score interpretation. |
| 26 | Returned-package handling | Add first-30-minutes-after-package-arrival operator decision table for scored, aggregate-only, partial-label, and unscoreable returns | todo | Self-generated after item 23; operationalizes the cold-start guard into time-ordered actions. |
| 27 | Infrastructure | Add returned-package state-transition validator for received -> terms -> format -> completeness -> safe-class -> report states | todo | Self-generated after item 23; validates no scoring/report state can be reached before gates pass. |
| 28 | Power/design | Add analyzable-pair confidence envelope table mapping partial-label counts to pass/fail/inconclusive wording under V43 power assumptions | todo | Self-generated after item 23; complements small-n language with machine-readable thresholds. |
