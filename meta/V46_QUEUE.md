...
| 22 | Returned-package handling | Add aggregate-only unscoreable-return composition dry run for missing required metrics plus failure-taxonomy wording | todo | Self-generated; covers returned packages that are valid to receive but cannot be scored. |
