...
| 2 | WS2 batch hardening | Add blind batch-diagnostic guard and rerun synthetic robustness | in-progress | Additive reporting only; do not change V22 rule or V42 thresholds. |
| 3 | WS3 prereg other leads | Pre-register postpartum APC-arm and T/B compartment monitoring leads | todo | Frozen specs and synthetic harnesses; no discovery. |
| 4 | WS4 self-audit weak leg | Resolve why V41 joint z is borderline while recurrence is strong | todo | Characterize modality contribution and influence on real held data. |
