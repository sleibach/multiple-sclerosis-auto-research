...
| 2 | completed | Define coupled-axis representations before response comparison. | `COUPLED_AXIS_V27.md` |
...
| 5 | completed | Prepare future validation harness and data-format spec. | `scripts/v27_apply_locked_rules.py`, `VALIDATION_READINESS_V27.md` |
| 6 | completed | Update resume state, README, session log, RAG index, commit. | checkpoint commit |

## Guardrails

- `LOCKED_RULE_V22.md` is immutable.
