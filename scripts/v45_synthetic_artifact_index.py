...
MANUAL_CLASS = {
    ...
    "analysis/v45_followup_escalation_packets": ("operations", "follow-up escalation drafts only"),
    ...
    "analysis/v46_report_header_metadata_linter": ("synthetic_intake_verification", "report-header metadata regression only"),
    "analysis/v46_report_header_repair_template_coverage": ("synthetic_intake_verification", "report-header repair-template coverage only"),
    "analysis/v46_safe_class_report_template_readiness": ("synthetic_intake_verification", "report-template readiness only"),
    ...
    "analysis/v46_safe_interpretation_example_coverage_linter": ("integrity_governance", "safe-interpretation example coverage only"),
    ...
    "analysis/v47_external_verifiable_intake_linter": ("integrity_governance", "external-verifiable intake lint only"),
    "analysis/v47_public_external_index": ("integrity_governance", "public external navigation index only"),
