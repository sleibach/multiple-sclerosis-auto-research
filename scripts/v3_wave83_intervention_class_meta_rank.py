...
SEED = 20260527
OUT = ROOT / "results_v3" / "wave83_intervention_class_meta_rank"

W23 = ROOT / "results_v3" / "wave23_metabolite_barrier_circuit" / "wave23_ranked_routes.tsv"
W44_CFB = ROOT / "results_v3" / "wave44_cfb_complement_stratification_audit" / "wave21_prior_CFB_row.tsv"
W48_ROUTE = ROOT / "results_v3" / "wave48_resolution_reopener_audit" / "route_reopener_audit.tsv"
W48_MATRIX = ROOT / "results_v3" / "wave48_resolution_reopener_audit" / "decision_matrix.tsv"
W50_GPR65 = ROOT / "results_v3" / "wave50_gpr65_acid_sensing_gpcr_audit" / "gpr65_audit.tsv"
W53 = ROOT / "results_v3" / "wave53_perturbation_first_pivot" / "perturbation_first_audit.tsv"
W54 = ROOT / "results_v3" / "wave54_mfge8_debris_opsonin_audit" / "decision_matrix.tsv"
W58 = ROOT / "results_v3" / "wave58_cxcr2_il7r_targeted_audit" / "cxcr2_il7r_decision.tsv"
W59 = ROOT / "results_v3" / "wave59_lysosomal_sphingolipid_model_reopener_audit" / "lysosomal_sphingolipid_decision.tsv"
W64 = ROOT / "results_v3" / "wave64_slamf7_perturbation_audit" / "wave64c_gate_row.tsv"
W72 = ROOT / "results_v3" / "wave72_lipid_mediator_intervention_scout" / "lipid_mediator_decisions.tsv"
W73 = ROOT / "results_v3" / "wave73_p2rx7_stratification_test" / "p2rx7_stratification_decision.tsv"
W74_GPR183 = ROOT / "results_v3" / "wave74_gpr183_oxysterol_niche" / "integrated_decision.tsv"
W74_EPHX2 = ROOT / "results_v3" / "wave74_ephx2_oxylipin_specificity" / "final_decision.tsv"
W78 = ROOT / "results_v3" / "wave78_lilrb_inhibitory_receptor_audit" / "lilrb_integrated_decision.tsv"
W79 = ROOT / "results_v3" / "wave79_targetability_shortlist_audit" / "targetability_integrated_decision.tsv"
W80 = ROOT / "results_v3" / "wave80_cd58_cd2_axis_deepening" / "cd58_cd2_axis_decision.tsv"
W82 = ROOT / "results_v3" / "wave82_parked_intervention_route_audit" / "parked_intervention_route_audit.tsv"
