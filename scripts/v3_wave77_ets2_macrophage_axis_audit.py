...
SEED = 20260527
OUT = ROOT / "phases/v3/results" / "wave77_ets2_macrophage_axis_audit"
GENE = "ETS2"
...
W68_PAIRED = ROOT / "phases/v3/results" / "wave68_gse282122_unrestricted_gene_screen" / "paired_gene_delta_tests.tsv"
W15_SYN = ROOT / "phases/v3/results" / "wave15_perturbation_drug_response" / "candidate_level_synthesis.tsv"
...
GENEFORMER_FILES = [
    ...
    ROOT / "phases/v3/results" / "wave70c_inhibitory_receptor_geneformer_direction" / "geneformer_direction_gene_summary.tsv",
    ROOT / "phases/v3/results" / "geneformer_broad_residual_delete" / "geneformer_broad_residual_gene_summary.tsv",
    ROOT / "phases/v3/results" / "geneformer_phagolysosomal_matrix_delete" / "geneformer_phagolysosomal_matrix_gene_summary.tsv",
]
