...
def main() -> None:
    ...
    specifications = [
        ...
        ("analysis/v54_progression_external_review/summary.json", "n_required_artifacts", "eq", 10),
        ...
        ("analysis/v54_progression_external_review/summary.json", "n_required_claim_boundaries", "eq", 7),
