...
def main() -> None:
    ...
    checks = [
        ...
        run("p1_analysis_release_regression", [python, "scripts/v54_progression_p1_analysis_release_gate.py"]),
        run("precision_receipt_router_regression", [python, "scripts/v54_progression_precision_receipt_router.py"]),
        run("artifact_index_regression", [python, "scripts/v54_progression_artifact_index.py"]),
        run("result_interpretation_regression", [python, "scripts/v54_progression_result_interpretation_gate.py"]),
        run("compute_ledger_regression", [python, "scripts/v54_progression_compute_ledger.py"]),
        run("candidate_state_reference", [python, "scripts/v54_progression_candidate_state_reference.py"]),
        run("endpoint_adjudication_regression", [python, "scripts/v54_progression_endpoint_adjudication.py"]),
        run("confirmation_provenance_gate_regression", [python, "scripts/v54_progression_confirmation_provenance_gate.py"]),
        ...
        run("negative_control_gate_regression", [python, "scripts/v54_progression_negative_control_gate.py"]),
        ...
        run("acquisition_request_packet", [python, "scripts/v54_progression_acquisition_request_packet.py"]),
        run("external_review_boundary_check", [python, "scripts/v54_progression_external_review_check.py"]),
    ...
    specifications = [
        ...
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "n_unique_simulated_cohorts", "eq", 96000),
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "n_null_families_invalid", "eq", 0),
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "n_precision_ready_designs", "eq", 0),
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "best_tested_design.n_requested", "eq", 1500),
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "best_tested_design.event_probability", "eq", 0.3),
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "best_tested_design.strict_precision_probability", "eq", 0.74),
        ("analysis/v54_progression_leave_site_out_precision/summary.json", "verdict", "eq", "PER_SITE_PRECISION_REQUIRES_MORE_THAN_SIGN_CONSISTENCY"),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "n_unique_simulated_cohorts", "eq", 72000),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "n_null_families_invalid", "eq", 0),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "n_precision_ready_designs", "eq", 4),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "ready_designs.0.n_requested", "eq", 1800),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "ready_designs.0.allocation", "eq", "balanced"),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "ready_designs.3.n_requested", "eq", 3000),
        ("analysis/v54_progression_leave_site_out_precision_extension/summary.json", "ready_designs.3.allocation", "eq", "imbalanced_60_30_10"),
        ...
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "n_template_fields", "eq", 66),
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "n_canonical_p1_or_all_fields", "eq", 50),
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "n_immediate_voi_extra_fields", "eq", 12),
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "n_confirmation_provenance_fields", "eq", 4),
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "n_immediate_bundles_covered", "eq", 5),
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "n_immediate_gate_fields", "eq", 51),
        ("analysis/v54_progression_acquisition_request_packet/summary.json", "overall_status", "eq", "PASS"),
        ...
        ("analysis/v54_progression_confirmation_error/summary.json", "n_unique_simulated_cohorts", "eq", 230400),
        ("analysis/v54_progression_confirmation_error/summary.json", "n_invalid_null_families", "eq", 4),
        ("analysis/v54_progression_confirmation_error/summary.json", "invalid_null_families", "contains", "score_miss_10pct"),
        ("analysis/v54_progression_confirmation_error/summary.json", "invalid_null_families", "contains", "score_false_2pct"),
        ("analysis/v54_progression_confirmation_error/summary.json", "invalid_null_families", "contains", "joint_miss_10pct"),
        ("analysis/v54_progression_confirmation_error/summary.json", "n_calibrated_families", "eq", 4),
        ("analysis/v54_progression_confirmation_error/summary.json", "complete_minimum_n_for_hr_1_5.event_015", "eq", 900),
        ("analysis/v54_progression_confirmation_error/summary.json", "complete_minimum_n_for_hr_1_5.event_030", "eq", 450),
        ("analysis/v54_progression_confirmation_error/summary.json", "verdict", "eq", "CONFIRMATION_DEPENDENCE_MUST_BE_AUDITED_BEFORE_PROGRESSION_INFERENCE"),
        ...
        ("analysis/v54_progression_negative_control_gate/summary.json", "n_fixtures", "eq", 10),
        ("analysis/v54_progression_negative_control_gate/summary.json", "n_pass", "eq", 10),
        ("analysis/v54_progression_negative_control_gate/summary.json", "n_expected_process_pass", "eq", 1),
        ("analysis/v54_progression_negative_control_gate/summary.json", "n_expected_fail_closed", "eq", 9),
        ("analysis/v54_progression_negative_control_gate/summary.json", "n_controls", "eq", 7),
        ("analysis/v54_progression_negative_control_gate/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_external_review/summary.json", "n_required_artifacts", "eq", 18),
        ("analysis/v54_progression_external_review/summary.json", "n_missing_artifacts", "eq", 0),
        ("analysis/v54_progression_external_review/summary.json", "n_missing_report_references", "eq", 0),
        ("analysis/v54_progression_external_review/summary.json", "n_required_report_references", "eq", 16),
        ("analysis/v54_progression_external_review/summary.json", "n_required_claim_boundaries", "eq", 11),
        ("analysis/v54_progression_external_review/summary.json", "n_missing_claim_boundaries", "eq", 0),
        ("analysis/v54_progression_external_review/summary.json", "overall_status", "eq", "PASS"),
        ...
        ("analysis/v54_progression_p1_analysis_release_gate/summary.json", "n_fixtures", "eq", 10),
        ("analysis/v54_progression_p1_analysis_release_gate/summary.json", "n_pass", "eq", 10),
        ("analysis/v54_progression_p1_analysis_release_gate/summary.json", "n_release_ready", "eq", 1),
        ("analysis/v54_progression_p1_analysis_release_gate/summary.json", "n_continue_accrual", "eq", 1),
        ("analysis/v54_progression_p1_analysis_release_gate/summary.json", "n_fail_closed", "eq", 8),
        ("analysis/v54_progression_p1_analysis_release_gate/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "n_fixtures", "eq", 11),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "n_pass", "eq", 11),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "n_precision_reference", "eq", 2),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "n_sign_reference", "eq", 1),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "n_reparameterize", "eq", 3),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "n_fail_closed", "eq", 5),
        ("analysis/v54_progression_precision_receipt_router/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_artifact_index/summary.json", "n_artifacts", "eq", 48),
        ("analysis/v54_progression_artifact_index/summary.json", "n_missing", "eq", 0),
        ("analysis/v54_progression_artifact_index/summary.json", "n_invalid", "eq", 0),
        ("analysis/v54_progression_artifact_index/summary.json", "n_readers", "eq", 4),
        ("analysis/v54_progression_artifact_index/summary.json", "by_reader.analysis_operator", "eq", 15),
        ("analysis/v54_progression_artifact_index/summary.json", "by_reader.method_reviewer", "eq", 16),
        ("analysis/v54_progression_artifact_index/summary.json", "by_reader.medical", "eq", 8),
        ("analysis/v54_progression_artifact_index/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_fixtures", "eq", 17),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_pass", "eq", 17),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_bounded_pass", "eq", 2),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_specificity_downgrade", "eq", 1),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_fail", "eq", 2),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_inconclusive", "eq", 7),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "n_invalid", "eq", 5),
        ("analysis/v54_progression_result_interpretation_gate/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_compute_ledger/summary.json", "n_count_rows", "eq", 57),
        ("analysis/v54_progression_compute_ledger/summary.json", "n_source_summaries", "eq", 46),
        ("analysis/v54_progression_compute_ledger/summary.json", "totals_by_category.model_fit_synthetic_cohorts", "eq", 3348600),
        ("analysis/v54_progression_compute_ledger/summary.json", "totals_by_category.planning_monte_carlo_replicates", "eq", 122805000),
        ("analysis/v54_progression_compute_ledger/summary.json", "totals_by_category.analysis_route_evaluations", "eq", 3875400),
        ("analysis/v54_progression_compute_ledger/summary.json", "totals_by_category.held_data_randomization_replicates", "eq", 2700000),
        ("analysis/v54_progression_compute_ledger/summary.json", "totals_by_category.synthetic_gate_fixtures", "eq", 187),
        ("analysis/v54_progression_compute_ledger/summary.json", "grand_total_intentionally_undefined", "eq", True),
        ("analysis/v54_progression_compute_ledger/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "n_source_artifacts", "eq", 3),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "n_missing", "eq", 0),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "n_hash_mismatch", "eq", 0),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "n_formula_checks", "eq", 6),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "n_formula_checks_pass", "eq", 6),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "compartment_boundary_explicit", "eq", True),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "overall_status", "eq", "PASS"),
        ("analysis/v54_progression_candidate_state_reference/summary.json", "verdict", "eq", "EXACT_V53_STATE_REFERENCE_VERIFIED_MICROGLIA_ONLY"),
        ...
        ("analysis/v54_progression_confirmation_provenance_gate/summary.json", "n_fixtures", "eq", 10),
        ("analysis/v54_progression_confirmation_provenance_gate/summary.json", "n_pass", "eq", 10),
        ("analysis/v54_progression_confirmation_provenance_gate/summary.json", "n_expected_process_pass", "eq", 2),
        ("analysis/v54_progression_confirmation_provenance_gate/summary.json", "n_expected_fail_closed", "eq", 8),
        ("analysis/v54_progression_confirmation_provenance_gate/summary.json", "overall_status", "eq", "PASS"),
