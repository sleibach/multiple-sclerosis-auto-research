...
def main() -> None:
    ...
    specifications = [
        ...
        ("analysis/v54_progression_external_review/summary.json", "n_required_artifacts", "eq", 17),
        ...
        ("analysis/v54_progression_external_review/summary.json", "n_required_report_references", "eq", 15),
        ("analysis/v54_progression_external_review/summary.json", "n_required_claim_boundaries", "eq", 10),
        ...
        ("analysis/v54_progression_artifact_index/summary.json", "n_artifacts", "eq", 46),
        ...
        ("analysis/v54_progression_artifact_index/summary.json", "by_reader.analysis_operator", "eq", 14),
