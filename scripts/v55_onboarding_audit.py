...
EXPECTED_DOCS = {
    ...
    "LINK_AND_LABEL_REVIEW_V55.md",
    "SEMANTIC_STRUCTURE_REVIEW_V55.md",
    "HUMAN_PILOT_RECRUITMENT_HANDOFF.md",
    "FIRST_SCREEN_REVIEW_V55.md",
    "MAINTAINER_TRIAGE_QUICK_CARD.md",
    "CLEAN_CLONE_SMOKE_TEST_V55.md",
    "COPY_PASTE_SAFETY_REVIEW_V55.md",
    "ANTI_DUPLICATION_ROUTE_REVIEW_V55.md",
    "ISSUE_FORM_FIELD_GUIDE_V55.md",
    "CONTRIBUTOR_ROUTE_CONSISTENCY_REVIEW_V55.md",
    "PUBLIC_PACKAGE_FOOTPRINT_V55.md",
    "TITLE_AND_ROLE_REVIEW_V55.md",
    "LANDING_PAGE_CHOICE_REVIEW_V55.md",
    "ZERO_JARGON_ENTRY_REVIEW_V55.md",
    "FINAL_DRIFT_AND_SAFETY_REVIEW_V55.md",
    "RELEASE_NOTES_V55.md",
    "INVITE_COLLABORATORS.md",
    "STARTER_CONTRIBUTIONS.md",
    "CONTRIBUTION_EXAMPLES_BY_TYPE.md",
