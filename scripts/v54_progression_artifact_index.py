...
ARTIFACTS = [
    ...
    row("M08", "medical", "run_summary", "grounded_review", "bounded_evidence", "docs/history/V54_RUN_SUMMARY.md", "Measured V54 execution and grounded outcome summary.", "The run summary preserves the no-progression-state/no-target verdict and separates method behavior from evidence."),
    ...
    row("A15", "analysis_operator", "candidate_identity", "operational_contract", "execution_authority_only", "docs/validation/PROGRESSION_P1_CANDIDATE_STATE_HANDOFF_V54.md", "Binds V54 P1 to the exact hashed V53 CD44/CXCR4 score identity.", "Only score identity transfers; microglia compatibility is mandatory and no progression claim transfers."),
    ...
    row("R16", "method_reviewer", "compute_accounting", "method_only_synthetic", "method_behavior_only", "docs/validation/PROGRESSION_COMPUTE_LEDGER_V54.md", "Separates V54 computational workload into non-additive units.", "Compute volume is not biological evidence and unlike units have no grand total."),
]
