...
def build_index(root: Path, outdir: Path) -> dict[str, object]:
    ...
    lines = [
        ...
        *count_lines,
        ...
        f"| {link('V48 model-lens usage boundary', 'catalogs/indexes/V48_MODEL_LENS_USAGE_BOUNDARY.md')} | Public boundary for using Claude, Gemini, and RPT as proposal lenses only. | governance/navigation only |",
        ...
        f"| {link('V48 convergence/contradiction executive card', 'synthesis/CONVERGENCE_CONTRADICTION_EXECUTIVE_CARD_V48.md')} | Medical-team summary of relationship counts, source-independence limits, and high-priority gaps. | synthesis/navigation only |",
        ...
        f"| {link('V48 contradiction surveillance checklist', 'synthesis/CONTRADICTION_SURVEILLANCE_CHECKLIST_V48.md')} | Future contradiction surveillance triggers by source class and finding category. | future-grounding control |",
        ...
        f"| {link('V48 external intake one-page checklist', 'templates/EXTERNAL_INTAKE_ONE_PAGE_CHECKLIST_V48.md')} | Compact operator checklist for routing source hits through V47/V48 intake controls. | future search/navigation only |",
        ...
        f"| {link('V48 source-hit access/terms parking queue', 'templates/SOURCE_HIT_ACCESS_TERMS_PARKING_QUEUE_V48.md')} | Safe parking template for promising source hits blocked by access, terms, reuse, or locator uncertainty. | future search/navigation only |",
        f"| {link('V48 source de-duplication intake checklist', 'templates/SOURCE_DEDUPLICATION_INTAKE_CHECKLIST_V48.md')} | Checklist for avoiding same-source overcounting before relationship or future-grounding intake. | future search/navigation only |",
        f"| {link('V48 parked source release checklist', 'templates/PARKED_SOURCE_RELEASE_CHECKLIST_V48.md')} | Checklist for moving a source hit out of access/terms parking without creating evidence. | future search/navigation only |",
        f"| {link('V48 parked source future-grounding handoff', 'templates/PARKED_SOURCE_FUTURE_GROUNDING_HANDOFF_V48.md')} | Rules for turning released, testable source hits into queued future-grounding tasks only. | future search/navigation only |",
        f"| {link('V48 source-intake audit log template', 'templates/SOURCE_INTAKE_AUDIT_LOG_TEMPLATE_V48.md')} | Audit trail template for future source-intake operator decisions. | future search/navigation only |",
        f"| {link('V48 source-intake decision error taxonomy', 'templates/SOURCE_INTAKE_DECISION_ERROR_TAXONOMY_V48.md')} | QA taxonomy for classifying future source-intake process errors. | future search/navigation only |",
        f"| {link('V48 source-intake reproducibility checklist', 'templates/SOURCE_INTAKE_REPRODUCIBILITY_CHECKLIST_V48.md')} | Reviewer checklist for reproducing future source-intake routing decisions. | future search/navigation only |",
        f"| {link('V48 source-intake stop/go scorecard', 'templates/SOURCE_INTAKE_STOP_GO_SCORECARD_V48.md')} | Pre-specified stop, park, or proceed routing template for future source hits. | future search/navigation only |",
        f"| {link('V48 source-intake reviewer handoff checklist', 'templates/SOURCE_INTAKE_REVIEWER_HANDOFF_CHECKLIST_V48.md')} | Session-to-session handoff checklist for future source-intake review. | future search/navigation only |",
        f"| {link('V48 source-intake controls coverage', 'catalogs/indexes/V48_SOURCE_INTAKE_CONTROLS_COVERAGE.md')} | Summary card mapping source-intake safeguards to failure modes. | governance/navigation only |",
        f"| {link('V48 active-time accounting audit', 'catalogs/indexes/V48_ACTIVE_TIME_ACCOUNTING_AUDIT.md')} | Operational card distinguishing cumulative active time from wall-clock span. | governance/navigation only |",
        ...
        f"| {link('V48 contradiction triage mini-template', 'templates/CONTRADICTION_TRIAGE_MINI_TEMPLATE_V48.md')} | Compact safe-routing template for future source hits that appear to disagree with grounded findings. | future search/navigation only |",
...
def synthetic_check(outdir: Path, fail_on_error: bool) -> int:
    ...
    checks = {
        ...
        "model_lens_usage_boundary_link_present": "V48_MODEL_LENS_USAGE_BOUNDARY.md" in text,
        ...
        "contradiction_surveillance_link_present": "CONTRADICTION_SURVEILLANCE_CHECKLIST_V48.md" in text,
        ...
        "external_intake_one_page_checklist_link_present": "EXTERNAL_INTAKE_ONE_PAGE_CHECKLIST_V48.md" in text,
        "source_hit_acceptance_decision_tree_link_present": "SOURCE_HIT_ACCEPTANCE_DECISION_TREE_V48.md" in text,
        "source_hit_access_terms_parking_queue_link_present": "SOURCE_HIT_ACCESS_TERMS_PARKING_QUEUE_V48.md" in text,
        "source_deduplication_intake_checklist_link_present": "SOURCE_DEDUPLICATION_INTAKE_CHECKLIST_V48.md" in text,
        "parked_source_release_checklist_link_present": "PARKED_SOURCE_RELEASE_CHECKLIST_V48.md" in text,
        "parked_source_future_grounding_handoff_link_present": "PARKED_SOURCE_FUTURE_GROUNDING_HANDOFF_V48.md" in text,
        "source_intake_audit_log_template_link_present": "SOURCE_INTAKE_AUDIT_LOG_TEMPLATE_V48.md" in text,
        "source_intake_decision_error_taxonomy_link_present": "SOURCE_INTAKE_DECISION_ERROR_TAXONOMY_V48.md" in text,
        "source_intake_reproducibility_checklist_link_present": "SOURCE_INTAKE_REPRODUCIBILITY_CHECKLIST_V48.md" in text,
        "source_intake_stop_go_scorecard_link_present": "SOURCE_INTAKE_STOP_GO_SCORECARD_V48.md" in text,
        "source_intake_reviewer_handoff_checklist_link_present": "SOURCE_INTAKE_REVIEWER_HANDOFF_CHECKLIST_V48.md" in text,
        "source_intake_controls_coverage_link_present": "V48_SOURCE_INTAKE_CONTROLS_COVERAGE.md" in text,
        "active_time_accounting_audit_link_present": "V48_ACTIVE_TIME_ACCOUNTING_AUDIT.md" in text,
        "relationship_row_candidate_template_link_present": "RELATIONSHIP_ROW_CANDIDATE_TEMPLATE_V48.md" in text,
        "contradiction_triage_mini_template_link_present": "CONTRADICTION_TRIAGE_MINI_TEMPLATE_V48.md" in text,
