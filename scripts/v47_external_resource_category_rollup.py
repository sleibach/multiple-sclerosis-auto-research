...
CATEGORY_LABELS = {
    ...
    "clinical_reference_and_guidelines": "Clinical reference and guidelines",
    "dmt_regulatory_and_drug_reference": "DMT regulatory and drug reference",
    "epidemiology_and_global_resources": "Epidemiology and global resources",
...
EXPLICIT_CATEGORY_TOKENS = [
    ...
    ("dailymed", "dmt_regulatory_and_drug_reference"),
    ("ema", "dmt_regulatory_and_drug_reference"),
    ...
    ("fda.fdalabel", "dmt_regulatory_and_drug_reference"),
    ...
    ("ms_society_uk", "clinical_reference_and_guidelines"),
    ("msif.atlas", "epidemiology_and_global_resources"),
    ("narcoms", "ms_registry_or_cohort_catalog"),
    ("national_ms_society.dmt", "dmt_regulatory_and_drug_reference"),
    ("national_ms_society", "clinical_reference_and_guidelines"),
    ("nhs_england.ms_dmt", "dmt_regulatory_and_drug_reference"),
    ("nice", "clinical_reference_and_guidelines"),
    ("ninds", "clinical_reference_and_guidelines"),
