...
OUT = ROOT / "results_v3" / "wave156_elr_chemokine_intervention_audit"
...
def main() -> None:
    wave155 = read_optional(ROOT / "results_v3" / "wave155_cux1_gene_specificity_vs_stat" / "gene_specificity_summary.tsv")
    wave21 = read_optional(ROOT / "results_v3" / "wave21_residual_druggability_scan" / "wave21_residual_druggability_rank.tsv")
    wave71 = read_optional(ROOT / "results_v3" / "wave71_global_survivor_meta_rank" / "global_survivor_meta_rank.tsv")
    wave103 = read_optional(ROOT / "results_v3" / "wave103_intervention_first_successor_triage" / "intervention_first_successor_rank.tsv")
