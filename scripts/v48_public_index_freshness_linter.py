...
REQUIRED_TARGETS = [
    ...
    "catalogs/indexes/SOURCE_DOMAIN_INDEPENDENCE_ROLLUP_V48.md",
    "catalogs/indexes/SOURCE_URL_DUPLICATE_REVIEW_V48.md",
    "catalogs/indexes/SOURCE_TERMS_COVERAGE_V48.md",
    "catalogs/indexes/SOURCE_TERMS_REVIEW_QUEUE_V48.md",
    "catalogs/indexes/HIGH_PRIORITY_SOURCE_TERMS_PACKET_V48.md",
    "catalogs/indexes/V48_GOVERNANCE_NAVIGATION.md",
    "catalogs/indexes/GOVERNANCE_FAILURE_MODE_MATRIX_V48.md",
    "catalogs/indexes/V48_EXTERNAL_SYNTHESIS_DEPENDENCY_GRAPH.md",
    ...
    "catalogs/indexes/V48_MODEL_LENS_USAGE_BOUNDARY.md",
    ...
    "synthesis/CONVERGENCE_SOURCE_INDEPENDENCE_V48.md",
    "synthesis/DECISION_RELEVANT_CONVERGENCES_V48.md",
    "synthesis/CONTRADICTION_READINESS_PLAYBOOK_V48.md",
    "synthesis/CONTRADICTION_SURVEILLANCE_CHECKLIST_V48.md",
    ...
    "templates/SOURCE_INTAKE_OPERATOR_QUICKSTART_V48.md",
    "templates/SOURCE_INTAKE_PACKAGE_MANIFEST_V48.md",
    "templates/EXTERNAL_INTAKE_ONE_PAGE_CHECKLIST_V48.md",
    "templates/SOURCE_HIT_ACCEPTANCE_DECISION_TREE_V48.md",
    "templates/SOURCE_HIT_ACCESS_TERMS_PARKING_QUEUE_V48.md",
    "templates/SOURCE_DEDUPLICATION_INTAKE_CHECKLIST_V48.md",
    "templates/PARKED_SOURCE_RELEASE_CHECKLIST_V48.md",
    "templates/PARKED_SOURCE_FUTURE_GROUNDING_HANDOFF_V48.md",
    "templates/SOURCE_INTAKE_AUDIT_LOG_TEMPLATE_V48.md",
    "templates/SOURCE_INTAKE_DECISION_ERROR_TAXONOMY_V48.md",
    "templates/SOURCE_INTAKE_REPRODUCIBILITY_CHECKLIST_V48.md",
    "templates/SOURCE_INTAKE_STOP_GO_SCORECARD_V48.md",
    "templates/SOURCE_INTAKE_REVIEWER_HANDOFF_CHECKLIST_V48.md",
    "catalogs/indexes/V48_SOURCE_INTAKE_CONTROLS_COVERAGE.md",
    "catalogs/indexes/V48_ACTIVE_TIME_ACCOUNTING_AUDIT.md",
    "templates/RELATIONSHIP_ROW_CANDIDATE_TEMPLATE_V48.md",
    "templates/CONTRADICTION_TRIAGE_MINI_TEMPLATE_V48.md",
