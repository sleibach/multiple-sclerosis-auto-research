...
ARTIFACTS = [
    ...
    },
    {
        "sequence": 5,
        "phase": "pre_touch_guard",
        "artifact_id": "receipt_manifest_to_command_plan_handoff",
        "role": "Map receipt-manifest lint outcomes to the next allowed classifier/planner command and hard stop.",
        "command": ".venv/bin/python scripts/v46_receipt_manifest_to_command_plan_handoff.py --outdir analysis/v46_receipt_manifest_to_command_plan_handoff --fail-on-error",
        "doc": "docs/validation/RECEIPT_MANIFEST_TO_COMMAND_PLAN_HANDOFF_V46.md",
        "primary_output": "analysis/v46_receipt_manifest_to_command_plan_handoff/receipt_manifest_to_command_plan_handoff_summary.json",
    },
    {
        "sequence": 6,
    ...
    },
    {
        "sequence": 8,
        "phase": "first_30_minutes",
        "artifact_id": "status_board_schema_linter",
        "role": "Verify team-update TSV/Markdown status-board outputs stay parseable and pre-result safe.",
        "command": ".venv/bin/python scripts/v46_returned_package_status_board_schema_linter.py --outdir analysis/v46_returned_package_status_board_schema_linter --fail-on-error",
        "doc": "docs/validation/RETURNED_PACKAGE_STATUS_BOARD_SCHEMA_LINTER_V46.md",
        "primary_output": "analysis/v46_returned_package_status_board_schema_linter/status_board_schema_linter_summary.json",
    },
    {
        "sequence": 9,
        "phase": "first_30_minutes",
