...
ENTRIES = [
    ...
    ("D", "Macnair lesion/stage localization", "agent", "grounded-real-data", "not-supported-after-source-adjustment", "analysis/v53_macnair_stage_lesion_heterogeneity/summary.json", "No context or stage survives the source-adjusted cross-partition gate."),
