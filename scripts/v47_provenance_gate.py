...
ALLOWED_NON_EXTERNAL_PREFIXES = [
    ...
    "analysis/v48_contradiction_surveillance_freshness_linter/",
    ...
    "analysis/v48_evidence_boundary_glossary_freshness_linter/",
    ...
    "analysis/v48_high_priority_external_sourcing_plan_freshness_linter/",
    ...
    "analysis/v48_relationship_matrix_data_dictionary_freshness_linter/",
    "analysis/v48_source_domain_relationship_freshness_linter/",
    "analysis/v48_source_domain_independence_freshness_linter/",
...
def audit_root(root: Path, outdir: Path) -> tuple[dict[str, object], list[GateIssue]]:
    ...
    summary = {
        ...
        "issues": rel(ROOT, outdir / "provenance_gate_issues.tsv"),
    }
...
def run_synthetic(outdir: Path) -> tuple[dict[str, object], list[dict[str, object]]]:
    ...
    summary = {
        ...
        "overall_status": "PASS" if n_fail == 0 else "FAIL",
        "cases": rel(ROOT, outdir / "synthetic_provenance_gate_cases.tsv"),
    }
