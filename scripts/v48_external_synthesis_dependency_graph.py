...
NODES = [
    ...
    },
    {
        ...
        "output": "knowledge_external/templates/SOURCE_HIT_ACCEPTANCE_DECISION_TREE_V48.md",
        "inputs": [
        ...
        "controls": ["scripts/v48_source_hit_acceptance_decision_tree_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
    ...
    },
    {
        ...
        "output": "knowledge_external/templates/SOURCE_DEDUPLICATION_INTAKE_CHECKLIST_V48.md",
        "inputs": [
            "knowledge_external/templates/SOURCE_INTAKE_PACKAGE_MANIFEST_V48.md",
            "knowledge_external/templates/SOURCE_HIT_ACCEPTANCE_DECISION_TREE_V48.md",
        ...
        "controls": ["scripts/v48_source_deduplication_intake_checklist_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
        "artifact": "Parked source release checklist",
        "output": "knowledge_external/templates/PARKED_SOURCE_RELEASE_CHECKLIST_V48.md",
        "inputs": [
            "knowledge_external/templates/SOURCE_HIT_ACCESS_TERMS_PARKING_QUEUE_V48.md",
        ...
        "controls": ["scripts/v48_parked_source_release_checklist_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
        "artifact": "Parked source future-grounding handoff",
        "output": "knowledge_external/templates/PARKED_SOURCE_FUTURE_GROUNDING_HANDOFF_V48.md",
        "inputs": [
            "knowledge_external/templates/SOURCE_HIT_ACCESS_TERMS_PARKING_QUEUE_V48.md",
        ...
        "controls": ["scripts/v48_parked_source_future_grounding_handoff_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
        "artifact": "External intake one-page checklist",
        "output": "knowledge_external/templates/EXTERNAL_INTAKE_ONE_PAGE_CHECKLIST_V48.md",
        "inputs": [
            "docs/knowledge/EPISTEMIC_CLASSES.md",
            "knowledge_external/EXTERNAL_LAYER_READER_BRIEF_V48.md",
            "knowledge_external/templates/SOURCE_INTAKE_PACKAGE_MANIFEST_V48.md",
        ...
        "controls": ["scripts/v48_external_intake_one_page_checklist_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
    ...
    },
    {
        ...
        "output": "knowledge_external/templates/SOURCE_INTAKE_REPRODUCIBILITY_CHECKLIST_V48.md",
        "inputs": [
            "knowledge_external/templates/EXTERNAL_INTAKE_ONE_PAGE_CHECKLIST_V48.md",
            "knowledge_external/templates/SOURCE_INTAKE_AUDIT_LOG_TEMPLATE_V48.md",
        ...
        "controls": ["scripts/v48_source_intake_reproducibility_checklist_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
    ...
    },
    {
        ...
        "controls": ["scripts/v48_relationship_row_candidate_template_freshness_linter.py"],
        "boundary": "future-search/navigation only",
    },
    {
