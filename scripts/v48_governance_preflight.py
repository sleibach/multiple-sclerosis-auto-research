...
CHECKS = [
    ...
    ("external_layer_reader_brief_freshness", ["scripts/v48_external_layer_reader_brief_freshness_linter.py", "lint"]),
    ("ai_core_tooling_health_freshness", ["scripts/v48_ai_core_tooling_health_freshness_linter.py", "lint"]),
    ("rpt_availability_claim", ["scripts/v48_rpt_availability_claim_linter.py", "lint"]),
    ("model_lens_usage_boundary_freshness", ["scripts/v48_model_lens_usage_boundary_freshness_linter.py", "lint"]),
    ("model_evidence_claim", ["scripts/v48_model_evidence_claim_linter.py", "lint"]),
    ...
    ("high_priority_external_sourcing_plan_freshness", ["scripts/v48_high_priority_external_sourcing_plan_freshness_linter.py", "lint"]),
    ("high_priority_source_search_query_freshness", ["scripts/v48_high_priority_source_search_query_freshness_linter.py", "lint"]),
    ("high_priority_source_intake_checklist_freshness", ["scripts/v48_high_priority_source_intake_checklist_freshness_linter.py", "lint"]),
    ("source_intake_operator_quickstart_freshness", ["scripts/v48_source_intake_operator_quickstart_freshness_linter.py", "lint"]),
    ("source_intake_package_manifest_freshness", ["scripts/v48_source_intake_package_manifest_freshness_linter.py", "lint"]),
    ("source_hit_acceptance_decision_tree_freshness", ["scripts/v48_source_hit_acceptance_decision_tree_freshness_linter.py", "lint"]),
    ("source_hit_access_terms_parking_queue_freshness", ["scripts/v48_source_hit_access_terms_parking_queue_freshness_linter.py", "lint"]),
    ("source_deduplication_intake_checklist_freshness", ["scripts/v48_source_deduplication_intake_checklist_freshness_linter.py", "lint"]),
    ("parked_source_release_checklist_freshness", ["scripts/v48_parked_source_release_checklist_freshness_linter.py", "lint"]),
    ("parked_source_future_grounding_handoff_freshness", ["scripts/v48_parked_source_future_grounding_handoff_freshness_linter.py", "lint"]),
    ("external_intake_one_page_checklist_freshness", ["scripts/v48_external_intake_one_page_checklist_freshness_linter.py", "lint"]),
    ("source_intake_audit_log_template_freshness", ["scripts/v48_source_intake_audit_log_template_freshness_linter.py", "lint"]),
    ("source_intake_decision_error_taxonomy_freshness", ["scripts/v48_source_intake_decision_error_taxonomy_freshness_linter.py", "lint"]),
    ("source_intake_reproducibility_checklist_freshness", ["scripts/v48_source_intake_reproducibility_checklist_freshness_linter.py", "lint"]),
    ("source_intake_stop_go_scorecard_freshness", ["scripts/v48_source_intake_stop_go_scorecard_freshness_linter.py", "lint"]),
    ("source_intake_reviewer_handoff_checklist_freshness", ["scripts/v48_source_intake_reviewer_handoff_checklist_freshness_linter.py", "lint"]),
    ("source_intake_controls_coverage_freshness", ["scripts/v48_source_intake_controls_coverage_freshness_linter.py", "lint"]),
    ("active_time_accounting_audit_freshness", ["scripts/v48_active_time_accounting_audit_freshness_linter.py", "lint"]),
    ("relationship_row_candidate_template_freshness", ["scripts/v48_relationship_row_candidate_template_freshness_linter.py", "lint"]),
    ("contradiction_triage_mini_template_freshness", ["scripts/v48_contradiction_triage_mini_template_freshness_linter.py", "lint"]),
