...
|---|---|---:|---:|---|
| `governance_preflight` | `PASS` | 48 | 0 | `analysis/v48_governance_preflight/v48_governance_preflight_summary.json` |
| `provenance_gate` | `PASS` | 358 | 0 | `analysis/v47_provenance_gate/provenance_gate_summary.json` |
| `governance_navigation` | `PASS` | 62 | 0 | `knowledge_external/catalogs/indexes/v48_governance_navigation_summary.json` |
