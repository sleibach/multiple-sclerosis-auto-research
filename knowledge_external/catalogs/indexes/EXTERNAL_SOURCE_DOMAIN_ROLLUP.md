...
|---|---|---|---|---|---|
| `ebi.ac.uk` | ArrayExpress in BioStudies | `external-unverifiable` | `orthogonal` | https://www.ebi.ac.uk/arrayexpress/ | `NOT_PROJECT_GROUNDED` |
| `ebi.ac.uk` | BioStudies | `external-unverifiable` | `orthogonal` | https://www.ebi.ac.uk/about/teams/biostudies/ | `NOT_PROJECT_GROUNDED` |
| `clinicaltrials.gov` | ClinicalTrials.gov | `external-unverifiable` | `orthogonal` | https://clinicaltrials.gov/ | `NOT_PROJECT_GROUNDED` |
| `dailymed.nlm.nih.gov` | DailyMed | `external-unverifiable` | `orthogonal` | https://dailymed.nlm.nih.gov/ | `NOT_PROJECT_GROUNDED` |
| `disgenet.com` | DISGENET | `external-unverifiable` | `orthogonal` | https://disgenet.com/ | `NOT_PROJECT_GROUNDED` |
| `datadryad.org` | Dryad | `external-unverifiable` | `orthogonal` | https://datadryad.org/ | `NOT_PROJECT_GROUNDED` |
| `ega-archive.org` | European Genome-phenome Archive | `external-unverifiable` | `orthogonal` | https://ega-archive.org/ | `NOT_PROJECT_GROUNDED` |
| `ema.europa.eu` | EMA Medicines | `external-unverifiable` | `orthogonal` | https://www.ema.europa.eu/en/medicines | `NOT_PROJECT_GROUNDED` |
| `ebi.ac.uk` | European Nucleotide Archive | `external-unverifiable` | `orthogonal` | https://www.ebi.ac.uk/ena/browser/ | `NOT_PROJECT_GROUNDED` |
| `europepmc.org` | Europe PMC | `external-unverifiable` | `orthogonal` | https://europepmc.org/ | `NOT_PROJECT_GROUNDED` |
| `fda.gov` | FDA FDALabel | `external-unverifiable` | `orthogonal` | https://www.fda.gov/science-research/bioinformatics-tools/fdalabel-full-text-search-drug-product-labeling | `NOT_PROJECT_GROUNDED` |
| `info.figshare.com` | Figshare | `external-unverifiable` | `orthogonal` | https://info.figshare.com/about/ | `NOT_PROJECT_GROUNDED` |
| `ncbi.nlm.nih.gov` | NCBI Gene Expression Omnibus | `external-unverifiable` | `orthogonal` | https://www.ncbi.nlm.nih.gov/geo/ | `NOT_PROJECT_GROUNDED` |
| `ebi.ac.uk` | NHGRI-EBI GWAS Catalog | `external-unverifiable` | `orthogonal` | https://www.ebi.ac.uk/gwas/ | `NOT_PROJECT_GROUNDED` |
| `imsgc.net` | International Multiple Sclerosis Genetics Consortium | `external-unverifiable` | `orthogonal` | https://imsgc.net/publications/ | `NOT_PROJECT_GROUNDED` |
| `mssociety.org.uk` | MS Society UK Types of MS | `external-unverifiable` | `orthogonal` | https://www.mssociety.org.uk/about-ms/types-of-ms | `NOT_PROJECT_GROUNDED` |
| `msbase.org` | MSBase Registry | `external-unverifiable` | `orthogonal` | https://www.msbase.org/ | `NOT_PROJECT_GROUNDED` |
| `msda.emif-catalogue.eu` | MS Data Alliance Catalogue | `external-unverifiable` | `orthogonal` | https://msda.emif-catalogue.eu/ | `NOT_PROJECT_GROUNDED` |
| `ngdc.cncb.ac.cn` | MSGD / Multiple Sclerosis Gene Database | `external-unverifiable` | `orthogonal` | https://ngdc.cncb.ac.cn/databasecommons/database/id/9285 | `NOT_PROJECT_GROUNDED` |
| `atlasofms.org` | MS International Federation Atlas of MS | `external-unverifiable` | `orthogonal` | https://atlasofms.org/ | `NOT_PROJECT_GROUNDED` |
| `narcoms.org` | NARCOMS Registry | `external-unverifiable` | `orthogonal` | https://www.narcoms.org/ | `NOT_PROJECT_GROUNDED` |
| `nationalmssociety.org` | National Multiple Sclerosis Society Disease Modification | `external-unverifiable` | `orthogonal` | https://www.nationalmssociety.org/for-professionals/for-healthcare-professionals/managing-and-treating-ms/disease-modification | `NOT_PROJECT_GROUNDED` |
| `nationalmssociety.org` | National Multiple Sclerosis Society Types of MS | `external-unverifiable` | `orthogonal` | https://www.nationalmssociety.org/understanding-ms/what-is-ms/types-of-ms | `NOT_PROJECT_GROUNDED` |
| `england.nhs.uk` | NHS England MS DMT treatment algorithm | `external-unverifiable` | `orthogonal` | https://www.england.nhs.uk/wp-content/uploads/2024/03/treatment-algorithm-for-multiple-sclerosis-disease-modifying-therapies-july-23.pdf | `NOT_PROJECT_GROUNDED` |
| `nice.org.uk` | NICE NG220 Multiple sclerosis in adults: management | `external-unverifiable` | `orthogonal` | https://www.nice.org.uk/guidance/ng220 | `NOT_PROJECT_GROUNDED` |
| `commondataelements.ninds.nih.gov` | NINDS Multiple Sclerosis Common Data Elements | `external-unverifiable` | `orthogonal` | https://www.commondataelements.ninds.nih.gov/Multiple%20Sclerosis | `NOT_PROJECT_GROUNDED` |
| `platform-docs.opentargets.org` | Open Targets Platform | `external-unverifiable` | `orthogonal` | https://platform-docs.opentargets.org/ | `NOT_PROJECT_GROUNDED` |
| `cos.io` | Open Science Framework | `external-unverifiable` | `orthogonal` | https://www.cos.io/products/osf | `NOT_PROJECT_GROUNDED` |
